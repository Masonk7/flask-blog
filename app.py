...
def index():
    ...
    #execute a query to read all posts from the posts table in the databse
    posts = conn.execute('SELECT * FROM posts').fetchall()

    #close the connection
    conn.close()

    #send teh posts to the index.html template to be displayed
...
def create():
    #determine if the page is being requested with a post or a get request
